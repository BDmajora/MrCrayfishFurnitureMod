...
public class RenderCounterSink
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        if (RenderHelper.getBlock(world, x, y, z, metadata, 1) instanceof BlockCounter) {
            if (RenderHelper.getRotation(world, x, y, z, metadata, 1) == 2) {
                RenderHelper.setRenderBounds(renderer, metadata, 0.0, 0.0, 0.125, 0.125, 0.875, 0.875);
        ...
        RenderHelper.setRenderBounds(renderer, metadata, 0.125, 0.0, 0.0, 1.0, 0.625, 1.0);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        RenderHelper.setRenderBounds(renderer, metadata, 0.75, 0.625, 0.0, 1.0, 1.0, 1.0);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        RenderHelper.setRenderBounds(renderer, metadata, 0.125, 0.625, 0.0, 0.75, 1.0, 0.0625);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        RenderHelper.setRenderBounds(renderer, metadata, 0.125, 0.625, 0.9375, 0.75, 1.0, 1.0);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        RenderHelper.setRenderBounds(renderer, metadata, 0.125, 0.625, 0.0625, 0.1875, 1.0, 0.9375);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        ...
        RenderHelper.renderBlock(renderer, block, x, y, z);
        renderer.setOverrideBlockTexture(Blocks.stained_hardened_clay.getIcon(0, 9));
        RenderHelper.setRenderBounds(renderer, metadata, 0.0, 0.875, 0.0, 0.125, 1.0, 1.0);
        RenderHelper.renderBlock(renderer, block, x, y, z);
        renderer.clearOverrideBlockTexture();
        TileEntityCounterSink tileEntityCounterSink = (TileEntityCounterSink)world.getTileEntity(x, y, z);
        if (tileEntityCounterSink.hasWater()) {
            ...
            RenderHelper.setRenderBounds(renderer, metadata, 0.125, 0.625, 0.0625, 0.75, 0.91, 0.9375);
