...
extends GuiContainer {
    ...
    public GuiFridge(IInventory par1IInventory, IInventory par2IInventory) {
        super((Container)new ContainerFridge(par1IInventory, par2IInventory));
        this.xSize = 176;
        this.ySize = 167;
    }

    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString("Fridge", this.xSize / 2 - 44, 6, 0x404040);
