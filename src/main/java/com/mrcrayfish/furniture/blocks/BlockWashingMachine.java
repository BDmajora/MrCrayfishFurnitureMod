...
public class BlockWashingMachine
extends BlockContainer {
    ...
    public int getRenderType() {
        return CommonProxy.renderWashingMachine;
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        TileEntityWashingMachine var7 = (TileEntityWashingMachine)par1World.getTileEntity(par2, par3, par4);
        if (var7 != null) {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
        ...
        if (!par1World.isRemote && (tile_entity = par1World.getTileEntity(par2, par3, par4)) instanceof TileEntityWashingMachine) {
    ...
    public Item getItemDropped(int i, Random random, int j) {
        return MrCrayfishFurnitureMod.itemWashingMachine;
    }

    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        return new ItemStack(MrCrayfishFurnitureMod.itemWashingMachine);
    }
