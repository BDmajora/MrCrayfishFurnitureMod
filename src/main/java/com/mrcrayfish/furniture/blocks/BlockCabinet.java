...
extends BlockContainer {
    ...
    public int getRenderType() {
        return CommonProxy.renderCabinet;
    }
    ...
    public Item getItemDropped(int i, Random random, int j) {
        return MrCrayfishFurnitureMod.itemCabinet;
    }

    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        TileEntityCabinet var7 = (TileEntityCabinet)par1World.getTileEntity(par2, par3, par4);
        if (var7 != null) {
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        return new ItemStack(MrCrayfishFurnitureMod.itemCabinet);
    }
