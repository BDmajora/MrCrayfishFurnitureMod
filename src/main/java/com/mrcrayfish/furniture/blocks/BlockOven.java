...
extends BlockContainer {
    private Random ovenRand = new Random();
    ...
    public Item getItemDropped(int par1, Random par2Random, int par3) {
        return MrCrayfishFurnitureMod.itemOven;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
        ...
        if (!par1World.isRemote && (tile_entity = par1World.getTileEntity(par2, par3, par4)) instanceof TileEntityOven && !par5EntityPlayer.isSneaking()) {
            TileEntityOven oven = (TileEntityOven)tile_entity;
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        TileEntityOven var7 = (TileEntityOven)par1World.getTileEntity(par2, par3, par4);
        if (var7 != null) {
            for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8) {
                ...
                while (var9.stackSize > 0) {
                    ...
                    float var15 = 0.05f;
                    var14.motionX = (float)this.ovenRand.nextGaussian() * var15;
                    var14.motionY = (float)this.ovenRand.nextGaussian() * var15 + 0.2f;
                    var14.motionZ = (float)this.ovenRand.nextGaussian() * var15;
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        return new ItemStack(MrCrayfishFurnitureMod.itemOven);
    }
    ...
    public Block setUnlocalizedName(String oven) {
        return null;
    }
}
