...
extends Block {
    ...
    public int getRenderType() {
        return CommonProxy.renderStonePath;
    }
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
        return !par1World.isAirBlock(par2, par3 - 1, par4) && par1World.getBlock(par2, par3 - 1, par4).isNormalCube();
    }

    public Item getItemDropped(int i, Random random, int j) {
        return MrCrayfishFurnitureMod.itemStonePath;
    }

    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        return new ItemStack(MrCrayfishFurnitureMod.itemStonePath);
    }
    ...
    public Block setUnlocalizedName(String stonepath) {
        return null;
    }
}
