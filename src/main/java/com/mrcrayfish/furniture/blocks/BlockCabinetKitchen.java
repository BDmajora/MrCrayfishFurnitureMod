...
public class BlockCabinetKitchen
extends BlockContainer {
    ...
    public int getRenderType() {
        return CommonProxy.renderKitchenCabinet;
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        TileEntityCabinetKitchen var7 = (TileEntityCabinetKitchen)par1World.getTileEntity(par2, par3, par4);
        if (var7 != null) {
    ...
    public Item getItemDropped(int i, Random random, int j) {
        return MrCrayfishFurnitureMod.itemKitchenCabinet;
    }

    public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z) {
        return new ItemStack(MrCrayfishFurnitureMod.itemKitchenCabinet);
    }
    ...
    public Block setUnlocalizedName(String kitchencabinet) {
        return null;
    }
}
