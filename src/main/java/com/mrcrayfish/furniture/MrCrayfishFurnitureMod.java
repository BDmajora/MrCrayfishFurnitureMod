...
//        hey = Block.getBlockFromItem(new BlockTVAnimation().setUnlocalizedName("hey").setTextureName("cfm:hey"));
//        nyan = Block.getBlockFromItem(new BlockTVAnimation().setUnlocalizedName("nyan").setTextureName("cfm:nyan"));
//        pattern = Block.getBlockFromItem(new BlockTVAnimation().setUnlocalizedName("pattern").setTextureName("cfm:pattern"));
//        yellowGlow = Block.getBlockFromItem(new BlockTVAnimation().setUnlocalizedName("yellowGlow").setTextureName("yellowGlow").setTextureName("cfm:yellowglow"));
//        whiteGlass = Block.getBlockFromItem(new BlockTVAnimation().setUnlocalizedName("whiteGlass").setTextureName("cfm:whiteglass"));
