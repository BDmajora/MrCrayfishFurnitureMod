...
public class ItemEnvelopeSigned
extends Item
implements IMail {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
        ...
        if (!par3World.isRemote) {
            NBTTagList var2 = (NBTTagList)NBTHelper.getCompoundTag(par1ItemStack, "Envelope").getTag("Items");
            if (var2.tagCount() > 0) {
                if (par2EntityPlayer.capabilities.isCreativeMode && par2EntityPlayer.isSneaking() && tile_entity instanceof TileEntityMailBox) {
                    ...
                    if (!tileEntityMailBox.isMailBoxFull() && par2EntityPlayer.isSneaking() && !par3World.isRemote) {
                        ...
                        par2EntityPlayer.addChatMessage((IChatComponent)new ChatComponentText("Thank you! - " + EnumChatFormatting.YELLOW + tileEntityMailBox.ownerName));
                        par2EntityPlayer.triggerAchievement((StatBase)FurnitureAchievements.sendMail);
                ...
                par2EntityPlayer.addChatMessage((IChatComponent)new ChatComponentText("You cannot insert a used envelope."));
            }
        }
        return true;
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        if (!par2World.isRemote && this == MrCrayfishFurnitureMod.itemEnvelopeSigned) {
            par3EntityPlayer.openGui((Object)MrCrayfishFurnitureMod.instance, 6, par2World, 0, 0, 0);
        }
